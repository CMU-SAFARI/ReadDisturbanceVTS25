...
int Program::get_num_insts() {
  return program.size();
}

Inst* Program::get_inst_seq()
{
  // TODO: The following postprocessing should happen after a program is concluded, not before sent to the board
  // linear_analysis();
  // insert_generated();
  // preprocess_branches();
