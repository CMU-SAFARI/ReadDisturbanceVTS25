...
public:
  ...
  /**
   * @brief    Conclude the program (MUST be called).
   * 
   * Adds an SMC_END() instruction, and performs linear analysis, insert generated instructions, and preprocess branches.
   */
  void conclude();
